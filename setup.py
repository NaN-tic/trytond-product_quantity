...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    url='https://github.com/NaN-tic/trytond-product_quantity',
    download_url='https://github.com:nantic/trytond-product_quantity.git',
    ...
    project_urls = {
       "Source Code": 'https://github.com:NaN-tic/trytond-product_quantity.git'
    },
    classifiers=[
